<?php /* Smarty version Smarty-3.1.14, created on 2016-04-13 20:25:23
         compiled from "/var/www/test/wa-apps/shop/templates/actions/product/Product.html" */ ?>
<?php /*%%SmartyHeaderCode:298242295570e810347b177-45669203%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ed35b91e59c58aedf9378e903a1cdc553f9694db' => 
    array (
      0 => '/var/www/test/wa-apps/shop/templates/actions/product/Product.html',
      1 => 1460566590,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '298242295570e810347b177-45669203',
  'function' => 
  array (
    'categories_select' => 
    array (
  ...
  'unifunc' => 'content_570e8103d1b300_54400776',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_570e8103d1b300_54400776')) {function content_570e8103d1b300_54400776($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/test/wa-system/vendors/smarty3/plugins/modifier.replace.php';
...
<?php $_tmp1=ob_get_clean();?><?php echo sprintf_wp('This product is not visible in the storefront because product type “%s” which this product belongs to is not allowed for publishing in any of your storefronts',$_tmp1);?>
...
">
                                    <td class="s-name">
                                        ...
                                        <span class="hint"><?php echo $_smarty_tpl->tpl_vars['sku']->value['sku'];?>
</span>
...
/edit/features/">Характеристики
        ...
        <li class="images">
            <a href="#/product/<?php echo $_smarty_tpl->tpl_vars['product']->value['id'];?>
/edit/images/">Изображения <span class="hint"><?php echo $_smarty_tpl->tpl_vars['counters']->value['images'];?>
</span>
            <span class="s-product-edit-tab-status"></span></a>
        </li>
        <li class="services">
...
" target="_blank" class="s-product-frontend-url"><?php echo $_smarty_tpl->tpl_vars['frontend_url']->value['url'];?>
                        ...
                        <p class="s-product-frontend-url-empty hint" <?php if (!empty($_smarty_tpl->tpl_vars['frontend_urls']->value)){?>style="display:none;"<?php }?>>
                            <?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['type']['name'], ENT_QUOTES, 'UTF-8', true);?>
<?php $_tmp2=ob_get_clean();?><?php echo _w(sprintf('This product is not visible in the storefront because product type “%s” which this product belongs to is not allowed for publishing in any of your storefronts',$_tmp2));?>
...
"
                            ...
                            <li class="<?php if (!empty($_smarty_tpl->tpl_vars['features']->value)&&$_smarty_tpl->tpl_vars['product']->value['sku_type']==shopProductModel::SKU_TYPE_SELECTABLE){?>selected<?php }?> <?php if (empty($_smarty_tpl->tpl_vars['features']->value)){?>gray<?php }?>">
                                <label>
                                    <a href="javscript:void(0);"><span<?php if (empty($_smarty_tpl->tpl_vars['features']->value)){?> class="gray"<?php }?>>Выбор параметров</span></a>
                    ...
                    <table class="s-product-skus">
                        <thead>
                            <tr class="white">
                                ...
                                <th>Артикул</th>
                                <th class="s-name"<?php if (count($_smarty_tpl->tpl_vars['product']->value['skus'])<=1){?> style="display:none;"<?php }?>>Наименование артикула</th>
                                <th>Цена</th>
                                <th>Количество</th>
                                <th colspan="2"></th>
                            </tr>
...
" placeholder="Артикул" title="Текстовый идентификатор товара, например, номер модели">
                                    </td>
                                    <td class="s-name"<?php if ($_smarty_tpl->tpl_vars['sku']->total<=1){?> style="display: none;"<?php }?>>
                                        <input type="text" name="skus[<?php echo $_smarty_tpl->tpl_vars['sku_id']->value;?>
][name]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sku']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" class="bold s-sku-name-input long<?php if (empty($_smarty_tpl->tpl_vars['sku']->value['available'])){?> grey<?php }?>" placeholder="Наименование артикула" title="Название артикула, которое покупатели видят на витрине вашего магазина">
                                    </td>
                                    <td class="s-price">
                                        <input type="text" name="skus[<?php echo $_smarty_tpl->tpl_vars['sku_id']->value;?>
...
/" class="inline-link nowrap inline-link js-action" title="Показать все настройки"><i class="icon16 settings"></i><b><i>Дополнительно</i></b></a>
                                    </td>
                                    <td class="extra-top-padded">
                                          <a href="#/product/<?php echo $_smarty_tpl->tpl_vars['product']->value['id'];?>
...
" class="s-input-virtual">
                            ...
                            <?php $_smarty_tpl->_capture_stack[0][] = array('template-sku-edit', null, null); ob_start(); ?>
                                ...
                                <tr data-id="{%=sku_id%}" class="{% if (sku.virtual == '1') { %}s-sku-virtual{% } %}">
                                    <td  class="s-sku-sort extra-top-padded min-width" style="white-space: nowrap;">
                                        <i class="icon16 sort"></i>
                                    ...
                                    <td class="s-sku">
                                        <input type="text" name="skus[{%=sku_id%}][sku]" value="{%=sku.sku%}" class="gray" placeholder="Артикул">
                                    </td>
                                    <td class="s-name">
                                        <input type="text" name="skus[{%=sku_id%}][name]" value="{%=sku.name%}" class="bold s-sku-name-input long" placeholder="Наименование артикула">
                                    </td>
                                    <td class="s-price">
                                        <input type="text" name="skus[{%=sku_id%}][price]" value="{%=sku.price_loc%}" class="bold large" placeholder="0">
...
<?php }?>
                                    ...
                                    <td class="extra-top-padded">
                                          <a href="#/product/{%=sku.product_id%}/edit/main/sku/settings/{%=sku_id%}/" class="inline-link nowrap js-action" title="Показать все настройки"><i class="icon16 settings"></i><b><i>Дополнительно</i></b></a>
                                    </td>
                                    <td class="extra-top-padded">
