<?php /* Smarty version Smarty-3.1.14, created on 2016-04-13 20:13:44
         compiled from "/var/www/test/wa-apps/shop/templates/actions/products/Products.html" */ ?>
<?php /*%%SmartyHeaderCode:1730532568570e7e48199d03-31744400%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3553ae2a281e2a3838aa907834b0a35ff6846889' => 
    array (
      0 => '/var/www/test/wa-apps/shop/templates/actions/products/Products.html',
      1 => 1460566593,
      2 => 'file',
    ),
    '1de6cacb4195eee1b23613d71d705015fce98af8' => 
    array (
      0 => '/var/www/test/wa-apps/shop/templates/actions/dialog/DialogProductListEmbed.html',
      1 => 1460566578,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1730532568570e7e48199d03-31744400',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_570e7e48572fc7_66247491',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_570e7e48572fc7_66247491')) {function content_570e7e48572fc7_66247491($_smarty_tpl) {?><?php if (!is_callable('smarty_function_wa_pagination')) include '/var/www/test/wa-system/vendors/smarty-plugins/function.wa_pagination.php';
...
&sort=stock_worth&order=<?php if ($_smarty_tpl->tpl_vars['order']->value=='desc'&&$_smarty_tpl->tpl_vars['sort']->value=='stock_worth'){?>asc<?php }else{ ?>desc<?php }?>" class="no-underline <?php if ($_smarty_tpl->tpl_vars['sort']->value=='stock_worth'){?>selected<?php }?>">стоимость активов</a><?php if ($_smarty_tpl->tpl_vars['sort']->value=='stock_worth'){?><i class="icon10 <?php if ($_smarty_tpl->tpl_vars['order']->value=='asc'){?>uarr-tiny<?php }else{ ?>darr-tiny<?php }?>"></i><?php }?></li>
            ...
            <!-- view mode -->
            <li class="list-view-mode list-view-mode-thumbs<?php if ($_smarty_tpl->tpl_vars['view']->value!='table'){?> selected<?php }?>">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../dialog/DialogProductListEmbed.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1730532568570e7e48199d03-31744400');
content_570e7e484a72c7_00388589($_smarty_tpl);
...
',
        ...
        <?php if (!empty($_smarty_tpl->tpl_vars['text']->value)){?>,
        text: <?php echo json_encode($_smarty_tpl->tpl_vars['text']->value);?>
        ...
        <?php }else{ ?>,page: <?php echo $_smarty_tpl->tpl_vars['page']->value;?>

        <?php }?>
    });
</script><?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2016-04-13 20:13:44
         compiled from "/var/www/test/wa-apps/shop/templates/actions/dialog/DialogProductListEmbed.html" */ ?>
<?php if ($_valid && !is_callable('content_570e7e484a72c7_00388589')) {function content_570e7e484a72c7_00388589($_smarty_tpl) {?><div  id="s-product-list-embed-dialog" class="dialog">
    <div class="dialog-background"></div>
    <div class="dialog-window">
        <div class="dialog-content">
