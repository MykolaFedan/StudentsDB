...
*/
   ...
   <a href="javascript:void(0);" class='btn btn_yellow' onclick="jQuery('#results_mode').val('only_wheels'); get_tire_results(true);" id="get_only_wheels_results"><?php echo $t['search_only_wheels']; ?></a>
